...
MY_CONSUMER_KEY = 'JJMroqyzfHrNttmOhtY1vZYuC'
MY_CONSUMER_SECRET = 'yVEHjZEV0HOeVvEdfMRRb6BvQNIcrBmeG8J4lMdJ8LA4exVsoC'
MY_ACCESS_TOKEN_KEY = 'JJMroqyzfHrNttmOhtY1vZYuC'
MY_ACCESS_TOKEN_SECRET = 'yVEHjZEV0HOeVvEdfMRRb6BvQNIcrBmeG8J4lMdJ8LA4exVsoC'
...
SOURCE_ACCOUNTS = ["boredelonmusk", "tesla", "spacex", "elonmusk","boringcompany"]  # A list of comma-separated, quote-enclosed Twitter handles of account that you'll generate tweets based on. It should look like ["account1", "account2"]. If you want just one account, no comma needed.
TWITTER_SOURCE_ACCOUNTS = ["boredelonmusk", "tesla", "spacex", "elonmusk","boringcompany"]  # A list of comma-separated, quote-enclosed Twitter handles of account that you'll generate tweets based on. It should look like ["account1", "account2"]. If you want just one account, no comma needed.
...
TWEET_ACCOUNT = "barklonhusk"  # The name of the account you're tweeting to.
